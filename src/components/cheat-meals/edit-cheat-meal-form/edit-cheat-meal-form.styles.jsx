...
export const EditCheatMealFormContainer = styled.div`
  display: flex;
...
export const EditCheatMealButtonsContainer = styled.div`
  display: flex;
...
export const EditCheatMealFormModalContainer = styled(Modal)`
    overlay: {
