...
export const EditMealTypeFormContainer = styled.div`
  display: flex;
...
export const EditMealTypeButtonsContainer = styled.div`
  display: flex;
...
export const EditMealTypeFormModalContainer = styled(Modal)`
    overlay: {
