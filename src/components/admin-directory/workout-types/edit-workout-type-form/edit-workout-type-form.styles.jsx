...
export const EditWorkoutTypeFormContainer = styled.div`
  display: flex;
...
export const EditWorkoutTypeButtonsContainer = styled.div`
  display: flex;
...
export const EditWorkoutTypeFormModalContainer = styled(Modal)`
    overlay: {
